...
Le module expose également une API sécurisée pour un système facial externe.
    ...
    "license": "LGPL-3",
    "depends": ["base", "mail", "hr", "survey", "web"],
    "data": [
    ...
    "assets": {
        "web.assets_backend": ["ar_visitors/static/src/js/kiosk_dialog.js", "ar_visitors/static/src/js/visitor_identify.js", "ar_visitors/static/src/scss/visitor_form.scss"],
